...
class Screen2Fragment : Fragment() {
    ...
    val args: Screen2FragmentArgs by navArgs()
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.tvName.setText(args.name)

        findNavController().currentBackStackEntry?.savedStateHandle?.getLiveData<String>("key_event")?.observe(viewLifecycleOwner) {result ->
